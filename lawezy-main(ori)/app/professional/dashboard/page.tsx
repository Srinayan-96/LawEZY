            ...
            <div className="flex flex-col md:flex-row gap-6">
              ...
              <div className="space-y-2">
                ...
                <div>
                  ...
                  <p className="font-medium">₹{userData.appointmentRate || userData.rate || "Not specified"}</p>
                </div>
                <div>
                  <p className="text-sm font-medium text-muted-foreground">Chat Rate</p>
                  <p className="font-medium">₹{userData.chatRate || userData.rate || "Not specified"}</p>
                </div>
                <Button asChild className="mt-2 bg-crimson-deep hover:bg-crimson-deep/90">
      ...
      <div>
        {status === "pending" ? (
          <div className="flex gap-2">
            <Button asChild size="sm" className="bg-crimson-deep hover:bg-crimson-deep/90">
...
function MessageItem({
  ...
  return (
    <div className="border-b pb-4">
      ...
      <Button asChild variant="link" className="p-0 h-auto mt-1 text-crimson-deep">
